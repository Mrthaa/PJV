...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList arr = new ArrayList(List.of(obj1, obj3, obj6, obj4, obj2, obj5));
        addToArrayList(arr, obj1); // Nic nepřidá, objekt už v ArrayListu je
        printAllObjects(arr);
        printPrimky(arr);
        printKvadra(arr);
    }

    private static boolean addToArrayList(ArrayList arr, Funkce fn) {
        if(!arr.contains(fn)) return arr.add(fn);
        return false;
    }

    private static void printAllObjects(ArrayList arr) {
        for(Object o : arr)
            System.out.println(o);
        System.out.println("");
    }

    private static void printPrimky(ArrayList arr) {
        for(Object o : arr)
            if(o instanceof Funkce_Primka) System.out.println(o);
        System.out.println("");
    }

    private static void printKvadra(ArrayList arr) {
        for(Object o : arr)
